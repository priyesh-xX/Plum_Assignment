      ...
      <footer className="backdrop-blur-md bg-black/80 border-t border-purple-900/50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8">
              ...
              <div>
                ...
                <div className="mt-4 space-y-2">
                  <button className="text-sm text-gray-400 hover:text-white block">Privacy Policy</button>
                  <button className="text-sm text-gray-400 hover:text-white block">Terms of Service</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">&copy; 2024 Gnosis. All rights reserved.</p>
